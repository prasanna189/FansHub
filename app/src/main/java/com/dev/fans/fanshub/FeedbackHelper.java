...
/**
 * Created by pk on 2/13/2018.
 */

class FeedbackHelper {

    private static final String EMAIL_ADDRESS = "spkforwork+fanshub@gmail.com";
    ...
    public static void sendFeedback(Context context) {
        ...
        File debugFile = null;
        String filename = context.getString(R.string.app_name) + "_debugInfo.txt";
        ...
        context.startActivity(Intent.createChooser(emailIntent, "Please share your feedback through EMAIL"));
//        debugFile.delete();
    }
